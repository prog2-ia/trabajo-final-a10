...
usuario3=Usuario('77777777G','Pedro','Ramirez',25)
usuario4=Usuario('88888888H','Sofia','Navarro',22)
usuario5=Usuario('99999999I','Diego','Torres',27)
usuario6=Usuario('10101010J','Elena','Vega',20)

genero1=Genero('Fantasía')
genero2=Genero('Ciencia ficción')
genero3=Genero('Programación')
genero4=Genero('Clásicos')
genero5=Genero('Novela')
genero6=Genero('Juvenil')